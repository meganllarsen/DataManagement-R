...
You will be required to install certain software on your personal computers, including R, RStudio, Git, and LaTeX.
This guide describes the software and how to install it. Originally developed by JT Lennon et al. from Indiana University.

## R

We will use R to manipulate, visualize, and statistically analyze data. If you already have R installed on your computer, you can check what version you currently have installed by typing `R.version` into the console. 
If not, we will install the latest version of R (v 3.4.1; "Single Candle") using the following insructions:

1. Open a web browser and naviate to the closest Canadian CRAN mirror: http://cran.utstat.utoronto.ca/
